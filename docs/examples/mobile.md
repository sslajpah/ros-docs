...
Example python class for controlling mobile robot via velocity control (/cmd_vel) with included odometry and laser scanner SICK NanoScan3 checkup.
...
class MobileRobotControl():
    ...
    def __init__(self, robot_name="YouBot"):
        rospy.init_node('mobile_robot_control_node', anonymous=True)
...
if __name__ == '__main__':
    ...
    robotcontrol_object = MobileRobotControl()
    try:
